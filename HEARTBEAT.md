...
- **DB health:** Run `sqlite3 /home/nhhnmm/.openclaw/workspace/data/products.db "SELECT COUNT(*) FROM products"` — should return `4`. If not, database may be missing or corrupted.
